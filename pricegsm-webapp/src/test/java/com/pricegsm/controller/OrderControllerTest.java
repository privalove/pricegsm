...
public class OrderControllerTest extends WebAppConfigurationAware {
    ...
    public void testGetPriceList() throws Exception {
        mockMvc.perform(get("/order/10000/99/pricelist.json"))
                ...
                .andExpect(jsonPath("$.payload.priceList.positions[0].prices[0].id", is(13)))
                .andExpect(jsonPath("$.payload.priceList.positions[0].prices[0].price", is(566.0)))
                .andExpect(jsonPath("$.payload.priceList.positions[0].prices[0].minOrderQuantity", is(2)))
                ...
                .andExpect(jsonPath("$.payload.priceList.positions[0].prices[2].id", is(53)))
                .andExpect(jsonPath("$.payload.priceList.positions[0].prices[2].price", is(536.0)))
                .andExpect(jsonPath("$.payload.priceList.positions[0].prices[2].minOrderQuantity", is(102)))
                ...
                .andExpect(jsonPath("$.payload.priceList.positions[1].prices[0].id", is(14)))
                .andExpect(jsonPath("$.payload.priceList.positions[1].prices[0].price", is(566.0)))
                .andExpect(jsonPath("$.payload.priceList.positions[1].prices[0].minOrderQuantity", is(2)))
                ...
                .andExpect(jsonPath("$.payload.priceList.positions[1].prices[2].id", is(54)))
                .andExpect(jsonPath("$.payload.priceList.positions[1].prices[2].price", is(536.0)))
                .andExpect(jsonPath("$.payload.priceList.positions[1].prices[2].minOrderQuantity", is(102)))
