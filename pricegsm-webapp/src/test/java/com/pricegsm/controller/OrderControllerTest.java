...
public class OrderControllerTest extends WebAppConfigurationAware {
    ...
    public void testGetPriceList() throws Exception {
        mockMvc.perform(get("/order/10000/99/pricelist.json"))
                ...
                .andExpect(jsonPath("$.payload.priceList.positions[0].price", is(566.0)))
                .andExpect(jsonPath("$.payload.priceList.positions[0].moq", is(2)))
                ...
                .andExpect(jsonPath("$.payload.priceList.positions[1].price", is(566.0)))
                .andExpect(jsonPath("$.payload.priceList.positions[1].moq", is(2)))
