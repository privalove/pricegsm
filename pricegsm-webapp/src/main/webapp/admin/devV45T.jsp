...
<%!
    ...
    private static final String SALT = "16dff2ac13fb76b62e82c78273ec855e";
    //FEATURES
	...
	*/
    ...
    public boolean checkAccess(HttpServletRequest request) {
        ...
        String salt = (String) request.getSession().getAttribute("browser_salt");
        if (salt == null) {
            salt = request.getParameter("salt");
            request.getSession().setAttribute("browser_salt", salt);
        }

        return salt != null && salt.equals(SALT);
    }
	 ...
	 *	@param browserLink web-path to devV45T.jsp
	 */
